    ...
    <>
      ...
      >
        ...
        <BorderBoxControl
          ...
          onChange={(values) =>
            setAttributes({
              styles: updateData(styles, values, "heading", "button", "border"),
            })
          }
        />
        ...
        <ColorControl
          ...
          onChange={(newColor) =>
            setAttributes({
              styles: updateData(styles, newColor, "heading", "title", "color"),
            })
          }
      ...
      {(themeSl === "themeOne" ||
        ...
        >
          ...
          <ColorControl
            ...
            onChange={(newColor) =>
              setAttributes({
                styles: updateData(styles, newColor, "items", "title", "color"),
              })
            }
          ...
          {(themeSl === "themeTwo" || themeSl === "themeFour") && (
            <>
              <PanelRow>
                <Label className="">{__("Icons Size", "b-blocks")}</Label>
                <Device />
              </PanelRow>
              <RangeControl
          ...
          {themeSl === "themeOne" && (
            <>
              <PanelRow>
                <Label className="">{__("Icons Size Width", "b-blocks")}</Label>
                <Device />
              </PanelRow>
              <RangeControl
                value={items?.icon?.size?.[device]?.width}
                onChange={(value) => {
                  setAttributes({
                    styles: updateData(
                      styles,
              ...
              <PanelRow>
                <Label className="">
                  {__("Icons Size Height", "b-blocks")}
                </Label>
                <Device />
              </PanelRow>
              <RangeControl
                value={items?.icon?.size?.[device]?.height}
                onChange={(value) => {
                  setAttributes({
                    styles: updateData(
                      styles,
      ...
      {themeSl === "themeThree" && (
        ...
        >
          ...
          <ColorControl
            ...
            onChange={(newColor) =>
              setAttributes({
                styles: updateData(styles, newColor, "item", "title", "color"),
              })
            }
