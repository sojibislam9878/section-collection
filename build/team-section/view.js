...
/***/ "./src/team-section/Components/Common/Style.js":
/*!*****************************************************!*\
  !*** ./src/team-section/Components/Common/Style.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_functions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/functions */ "./src/team-section/utils/functions.js");
...
const Style = ({
  ...
  const imageShadowValue = image?.shadow?.map(s => (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getShadowCSS)(s, "box")).join(", ") || "none";
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `

        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", badge?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", title?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", name?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", role?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", subTitle?.typography)?.googleFontLink}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", description?.typography)?.googleFontLink}
        
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(headingBtnSubtitleSl, badge?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(headingTitleSl, title?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(itemTeamMemberNameSl, name?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(itemTeamMemberRoleSl, role?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(secTitleTitleSl, subTitle?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(secTitleTitleH2Sl, title?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(speakerInfoBoxNameSl, name?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(speakerInfoBoxDesignationSl, role?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(sectionTitleSl, title?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(descriptionSl, description?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(teamRoleSl, role?.typography)?.styles}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(teamTwoNameTypoSl, name?.typography)?.styles}
        ...
        ${itemTeamMemberContentSl} .rounded {
         border-radius :${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(infoBox?.borderRadius)} 
        }
        ...
        ${teamTwoNameTypoSl}{
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(name?.margin)};
        }

        ${teamRoleSl}{
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(role?.margin)};
        }

        ${sectionTitleSl}{
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(title?.margin)};
          color: ${title?.color};
        }
        ...
        ${descriptionSl}{
          ...
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(description?.margin)};
        }
        ...
        ${sectionTwoSl}{
          ...
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(container?.margin)};
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(container?.padding)};
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(container?.borderRadius)};
        }
        ...
        ${secTitleTitleSl}{
          background: ${(0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.getGradientCSS)(subTitle?.gradient)};
          -webkit-background-clip: text;
          background-clip: text;
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(subTitle?.margin)};
        }
        ...
        ${speakerImageBoxImgSl}{
          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(image?.border)}
          border-radius: 50%;
        }
        ...
        ${itemTeamMemberIconSl}{
         ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(linkArrowIcon?.border)}
          ...
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(linkArrowIcon?.borderRadius)}; 
        ...
        ${headingBtnSl}{
          ...
          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(badge?.border)}
          color: ${badge?.bgColor?.normal?.color};
          fill: ${badge?.bgColor?.normal?.color};
          padding: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(badge?.padding)};
          margin: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(badge?.margin)};
          border-radius: ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(badge?.borderRadius)};
        }
...
/***/ "./src/team-section/Components/TeamSection/TeamSectionDefault.js":
/*!***********************************************************************!*\
  !*** ./src/team-section/Components/TeamSection/TeamSectionDefault.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TeamSectionDefault = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, heading?.subtitle)), isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    ...
    className: "mb-0 mx-auto title"
  }, heading?.title)))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "row g-4"
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, isEditor && items?.length > 0 ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUploadCheck, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUpload, {
      ...
      className: "team-member-1__content px-2 px-sm-4 px-xl-2 px-xxl-4 z-1 position-relative"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "d-flex align-items-center gap-3 rounded bg-light-subtle p-4 px-sm-6 px-lg-4 shadow-sm"
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      onChange: newName => {
        setAttributes({
          team: {
            ...team,
            items: items.map((i, iIndex) => iIndex === index ? {
              ...i,
              name: newName
            } : i)
          }
      ...
      className: "link d-block fs-18 fw-bold mb-1 text-heading hover:text-primary name"
    }, item?.name), isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
      tagName: "p",
      ...
      className: "mb-0 fs-14 role"
    }, item?.role)), isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TeamSectionDefault);

/***/ }),

/***/ "./src/team-section/Components/TeamSection/TeamSectionOne.js":
/*!*******************************************************************!*\
  !*** ./src/team-section/Components/TeamSection/TeamSectionOne.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TeamSectionOne = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `team-section ${styleSl}`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("section", {
    className: "speakers-section-three"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, heading?.title)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "row"
    ...
    className: "designation"
  }, item?.role)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "social-box"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "social-links social-icon-colored"
  }, item?.socialLinks?.map((social, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    key: index
    ...
    href: social?.url,
    target: item?.isSocialLinksNewTab ? "_blank" : "_self",
    rel: "noreferrer noopener"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "social-icon",
    dangerouslySetInnerHTML: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TeamSectionOne);

/***/ }),

/***/ "./src/team-section/Components/TeamSection/TeamSectionTwo.js":
/*!*******************************************************************!*\
  !*** ./src/team-section/Components/TeamSection/TeamSectionTwo.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const TeamSectionTwo = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "container"
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "span",
    ...
    className: "highlight_secondary"
  }, heading?.highlightText), heading?.titleText), isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", {
    ...
    className: "team-description"
  }, heading?.descriptionLine1, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("br", null), heading?.descriptionLine2), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "hr big_size_hr invisible_hr"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("i", {
    className: "fa fa-"
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "row"
  }, items?.slice(0, headingNumberOfPerson).map((item, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
  ...
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUploadCheck, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.MediaUpload, {
    onSelect: media => {
      setAttributes({
        team: {
          ...team,
    ...
    className: "team-name"
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "h5",
    placeholder: "Enter Name",
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"],
    keepPlaceholderOnFocus: true,
    ...
    target: item?.isOpenNewTab ? "_blank" : "_self",
    rel: "noreferrer noopener"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, item?.name))), isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    tagName: "div",
    className: "team-role",
    placeholder: "Enter Role",
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"],
    ...
    className: "row"
  }, items?.slice(headingNumberOfPerson).map((item, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
    ...
    onSelect: media => {
      setAttributes({
        team: {
          ...team,
          items: items?.map((i, iIndex) => iIndex === index + 3 ? {
            ...i,
            image: media?.url
          } : i)
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TeamSectionTwo);

/***/ }),

/***/ "./src/team-section/style.scss":
/*!*************************************!*\
  !*** ./src/team-section/style.scss ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/team-section/utils/functions.js":
/*!*********************************************!*\
  !*** ./src/team-section/utils/functions.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getGradientCSS: () => (/* binding */ getGradientCSS),
/* harmony export */   getNewItemByStyle: () => (/* binding */ getNewItemByStyle),
...
const getNewItemByStyle = styleSl => {
  switch (styleSl) {
    case "styleDefault":
      return {
...
(() => {
/*!**********************************!*\
  !*** ./src/team-section/view.js ***!
  \**********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/team-section/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/team-section/Components/Common/Style.js");
/* harmony import */ var _Components_TeamSection_TeamSectionDefault__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/TeamSection/TeamSectionDefault */ "./src/team-section/Components/TeamSection/TeamSectionDefault.js");
/* harmony import */ var _Components_TeamSection_TeamSectionOne__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/TeamSection/TeamSectionOne */ "./src/team-section/Components/TeamSection/TeamSectionOne.js");
/* harmony import */ var _Components_TeamSection_TeamSectionTwo__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/TeamSection/TeamSectionTwo */ "./src/team-section/Components/TeamSection/TeamSectionTwo.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-b-blocks-team-section");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), styleSl === "styleDefault" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_TeamSection_TeamSectionDefault__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    }), styleSl === "styleOne" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_TeamSection_TeamSectionOne__WEBPACK_IMPORTED_MODULE_5__["default"], {
      attributes: attributes
    }), styleSl === "styleTwo" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_TeamSection_TeamSectionTwo__WEBPACK_IMPORTED_MODULE_6__["default"], {
      attributes: attributes
    })));
