  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      ...
      ${sectionSpaceBottomSl}{
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding-bottom", `${heading?.layout?.sectionPadding?.desktop}px`)}
      }

      ${aboutFourItemIconSl} {
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("color", items?.icon?.bgColor?.normal.color)}
        ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("fill", items?.icon?.bgColor?.normal.color)}
