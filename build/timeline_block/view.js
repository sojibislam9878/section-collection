...
/***/ "./src/timeline_block/Components/Common/Style.js":
/*!*******************************************************!*\
  !*** ./src/timeline_block/Components/Common/Style.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", styles.leftCard.text.title.typo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", styles.leftCard.text.description.typo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", styles.timelines.title.typo)?.googleFontLink}
    ...
    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(timelineDescriptionSl, styles.timelines.description.typo)?.styles}
		...
		${pluginSl}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(styles.bodyBg)}
			width:${layout.body?.width?.desktop};
			min-height:${layout.body?.height?.desktop};
			border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(layout.section.borderRadius)};
			margin:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(layout.body.margin.desktop)};
			padding:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(layout.body.padding.desktop)};
		}
		...
		${btnSl}{
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getColorsCSS)(styles.button)}
		}
    ...
    @media  (min-width:641px) and (max-width: 1024px){
        ${pluginSl}{ 
			...
			padding:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(layout.body.padding.tablet)};
      }
    ...
    @media (max-width: 480px){
			...
			padding:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(layout.body.padding.mobile)};
      }
...
/***/ "./src/timeline_block/Components/Common/Timeline1.js":
/*!***********************************************************!*\
  !*** ./src/timeline_block/Components/Common/Timeline1.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Compos_BallSvg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Compos/BallSvg */ "./src/timeline_block/Components/Compos/BallSvg.js");
...
const Timeline1 = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }), options.button.status && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "link",
    ...
    className: " left-cards-cont"
  }, timeline.leftContent.cards.map((card, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "left-card",
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "lists-cont dashed-line"
  }, timeline.timelines.map((tl, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    className: "list",
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "timeline-serial"
  }, index < 9 ? `0${index + 1}` : `${index + 1}`), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: tl.title,
    onChange: value => setAttributes({
      timeline: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(timeline, value, "rightContent", index, "title")
    }),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("title...")
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    ...
    onChange: value => setAttributes({
      timeline: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(timeline, value, "rightContent", index, "description")
    }),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("description...")
    ...
    className: "title"
  }, tl.title), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "description"
  }, tl.description, " ")))))))))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Timeline1);

/***/ }),

/***/ "./src/timeline_block/Components/Common/Timeline2.js":
/*!***********************************************************!*\
  !*** ./src/timeline_block/Components/Common/Timeline2.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_functions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/functions */ "./src/timeline_block/utils/functions.js");
...
const Timeline2 = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: timeline.header,
    onChange: value => setAttributes({
      timeline: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(timeline, value, "header")
    }),
    ...
    onChange: value => setAttributes({
      timeline: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(timeline, value, "description")
    }),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("Title...")
  })) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", null, "How does AI Image Work?"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, "Your own generative AI Large Language Model framework, designed and launched. Take creativity a step further with the transformative power of our Image Generation tool. Its not just about bringing"))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "body",
    style: {
      display: "flex",
    ...
    value: tl.title,
    onChange: value => setAttributes({
      timeline: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(timeline, value, "rightContent", index, "title")
    }),
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)("title...")
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    className: "description",
    ...
    value: tl.description,
    onChange: value => setAttributes({
      timeline: (0,_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(timeline, value, "rightContent", index, "description")
    }),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Timeline2);
{
  /* Timeline with dots  */
}
...
/***/ "./src/timeline_block/Components/Compos/BallSvg.js":
/*!*********************************************************!*\
  !*** ./src/timeline_block/Components/Compos/BallSvg.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const BallSvg = () => {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    ...
    filter: "url(#filter0_f_10395_2005)"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BallSvg);

/***/ }),

/***/ "./src/timeline_block/style.scss":
/*!***************************************!*\
  !*** ./src/timeline_block/style.scss ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/timeline_block/utils/functions.js":
/*!***********************************************!*\
  !*** ./src/timeline_block/utils/functions.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!************************************!*\
  !*** ./src/timeline_block/view.js ***!
  \************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/timeline_block/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/timeline_block/Components/Common/Style.js");
/* harmony import */ var _Components_Common_Timeline1__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/Timeline1 */ "./src/timeline_block/Components/Common/Timeline1.js");
/* harmony import */ var _Components_Common_Timeline2__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/Common/Timeline2 */ "./src/timeline_block/Components/Common/Timeline2.js");
...
document.addEventListener("DOMContentLoaded", () => {
  const blockNameEls = document.querySelectorAll(".wp-block-b-blocks-timeline-wpblock");
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), selectedTheme === "theme1" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Timeline1__WEBPACK_IMPORTED_MODULE_4__["default"], {
      attributes: attributes
    }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Timeline2__WEBPACK_IMPORTED_MODULE_5__["default"], {
      attributes: attributes
    })));
