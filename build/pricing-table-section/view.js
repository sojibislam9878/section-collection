...
/***/ "./src/pricing-table-section/Components/Common/Style.js":
/*!**************************************************************!*\
  !*** ./src/pricing-table-section/Components/Common/Style.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Style = ({
  ...
  const generateIconFillCSS = () => {
    return MinimalPriceCardData.map((card, cardIndex) => card.features.map((feature, featureIndex) => `.pricing-card-${cardIndex} .icon-${featureIndex} svg path {
  ...
  const generateIconFillCSSTwo = () => {
    return MinimalPriceCardData?.map((card, cardIndex) => card.features.map((feature, featureIndex) => `.pricing-card-${cardIndex} .icon-${featureIndex} svg {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", style?.headerStyle?.titleStyle?.typo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", style?.headerStyle?.desStyle?.desTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", hightLightTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", CardTitleTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", CardAmountTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", CardPeriodTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", CardDesTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", cardButtonTypo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)("", featuresTypo)?.googleFontLink}

			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.titleStyle?.titleTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.priceStyle?.amountTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.priceStyle?.periodTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.priceStyle?.descriptionTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.featuresSectionStyle?.featureTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.actionStyle?.getStartedTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.featuredStyle?.featuredTitleTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.featuredStyle?.featuredAmountTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.featuredStyle?.featuredPeriodTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.featuredStyle?.featuredDescriptionTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.featuredStyle?.featuredFeatureSectionStyle?.featureTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.featuredStyle?.actionStyle?.getStartedTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.footerStyle?.footerTitleTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.footerStyle?.footerDesTypo)?.googleFontLink}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)('', styleTwo?.tabileRowStyle?.footerStyle?.footerIconTextTypo)?.googleFontLink}




		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(pricingH1, style?.headerStyle?.titleStyle?.typo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(pricingP, style?.headerStyle?.desStyle?.desTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(popularTag, hightLightTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(cardH3, CardTitleTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(amount, CardAmountTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(period, CardPeriodTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(description, CardDesTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(btn, cardButtonTypo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(cardUi, featuresTypo)?.styles}


			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(cardH2, styleTwo?.tabileRowStyle?.titleStyle?.titleTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(amountTwo, styleTwo?.tabileRowStyle?.priceStyle?.amountTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(periodTwo, styleTwo?.tabileRowStyle?.priceStyle?.periodTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(descriptionTwo, styleTwo?.tabileRowStyle?.priceStyle?.descriptionTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(feaTtem, styleTwo?.tabileRowStyle?.featuresSectionStyle?.featureTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(getStarted, styleTwo?.tabileRowStyle?.actionStyle?.getStartedTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(featuredCardH2, styleTwo?.tabileRowStyle?.featuredStyle?.featuredTitleTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(featuredAmount, styleTwo?.tabileRowStyle?.featuredStyle?.featuredAmountTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(featuredPeriod, styleTwo?.tabileRowStyle?.featuredStyle?.featuredPeriodTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(featuredDescription, styleTwo?.tabileRowStyle?.featuredStyle?.featuredDescriptionTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(featuredFeaItem, styleTwo?.tabileRowStyle?.featuredStyle?.featuredFeatureSectionStyle?.featureTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(featuredGetStarted, styleTwo?.tabileRowStyle?.featuredStyle?.actionStyle?.getStartedTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(footerh3, styleTwo?.tabileRowStyle?.footerStyle?.footerTitleTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(footerp, styleTwo?.tabileRowStyle?.footerStyle?.footerDesTypo)?.styles}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getTypoCSS)(footerIconText, styleTwo?.tabileRowStyle?.footerStyle?.footerIconTextTypo)?.styles}
		...
		${pricingCard}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardRadius))}
		...
		${popularTag}{
		  ...
		  color:${color};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(hightLightRadius))}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(padding?.desktop))}
		}
		${cardHeader}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardPadding?.desktop))}
		}
		${cardH3}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardMargin?.desktop))}
		...
		${period}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardPeriodMargin?.desktop))}
		}
		${description}{
		  color:${cardDesColor};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardDesMargin?.desktop))}
		}
		${btn}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardButtonRadius))}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardButtonPadding?.desktop))}
		}
		${btnOutline}{
		...
		${cardFeatures}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(featuresPadding?.desktop))}
		}
		${cardUi}{
		 color:${priceCardStyle?.priceFeatures?.featureColor};
		}
		${cardLi}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(featuresMargin?.desktop))}
		}
		${icon}{
		width:${iconWidth};
		  height:${iconWidth};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(iconMargin?.desktop))}
		}
   	    ${generateIconFillCSS()}
		...
		@media only screen and (min-width: 641px) and (max-width: 1024px) {
            ${popularTag} {
	          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(padding?.tablet))}
            }
			${cardHeader}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardPadding?.tablet))}
		    }
			${cardH3}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardMargin?.tablet))}
		    }
			${period}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardPeriodMargin?.tablet))}
		    }
			${description}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardDesMargin?.tablet))}
		    }
			${btn}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardButtonPadding?.tablet))}
		    }
			${btn}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardButtonPadding?.tablet))}
		    }
			${cardFeatures}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(featuresPadding?.tablet))}
		    }
			${cardLi}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(featuresMargin?.tablet))}
		    }
			${icon}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(iconMargin?.tablet))}
		    }
			${pricingGrid}{
		...
		@media only screen and (max-width: 641px) {
			${popularTag} {
	          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(padding?.mobile))}
            }
			${cardHeader} {
	          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardPadding?.mobile))}
            }
			${cardH3}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardMargin?.mobile))}
		    }
			${period}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardPeriodMargin?.mobile))}
		    }
			${description}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardDesMargin?.mobile))}
		    }
			${btn}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("Padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(cardButtonPadding?.mobile))}
		    }
			${cardFeatures}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("Padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(featuresPadding?.mobile))}
		    }
			${cardLi}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(featuresMargin?.mobile))}
		    }
			${icon}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(iconMargin?.mobile))}
		    }
		    ${pricingGrid}{
		...
		${pricingCardTwo}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.tableRadius))}
		...
		${cardSection}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.tablePadding?.desktop))}
		}
		${cardH2}{
		  color:${styleTwo?.tabileRowStyle?.titleStyle?.titleColor};
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.titleStyle?.titleMargin?.desktop))}
		}
		${priceTwo}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.priceStyle?.priceMarging?.desktop))}
		}
		${amountTwo}{
		...
		${periodTwo}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.priceStyle?.periodMargin?.desktop))}
		}
		${descriptionTwo}{
		...
		${featuresSection}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuresSectionStyle?.featuresPadding?.desktop))}
		...
		${getStarted}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.actionStyle?.getStartedRadius))}
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.actionStyle?.getStartedPadding?.desktop))}
		}
        ...
        ${featured}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredRadius))}
		...
		${featuredCardSection}{
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredPadding?.desktop))}
		}
		${featuredCardH2}{
		 color:${styleTwo?.tabileRowStyle?.featuredStyle?.featuredTitleColor};
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredTitleMargin?.desktop))}
		}
		${featuredPrice}{
           ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredPriceMarging?.desktop))}
		}
        ${featuredAmount}{
		...
		${featuredPeriod}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredPeriodMargin?.desktop))}
		}
		${featuredDescription}{
		  color:${styleTwo?.tabileRowStyle?.featuredStyle?.featuredDescriptionColor};
		}
		${featuredSection}{
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredFeatureSectionStyle?.featuresPadding?.desktop))}
		...
		${featuredGetStarted}{
		 ...
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.actionStyle?.getStartedRadius))}
		 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.actionStyle?.getStartedPadding?.desktop))}
		}
		...
		${footerp}{
		  ...
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.footerStyle?.footerDesMargin?.desktop))}
		}
	    ${footerIconText}{
	    ...
	    @media only screen and (min-width: 641px) and (max-width: 1024px) {
		  ${cardSection}{
             ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.tablePadding?.tablet))}
		  }
		  ${cardH2}{
		    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.titleStyle?.titleMargin?.tablet))}
		  }
		  ${priceTwo}{
		    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.priceStyle?.priceMarging?.tablet))}
		  }
		  ${periodTwo}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.priceStyle?.periodMargin?.tablet))}
		  }
		  ${featuresSection}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuresSectionStyle?.featuresPadding?.tablet))}
		  }
		  ${getStarted}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.actionStyle?.getStartedPadding?.tablet))}
		  }
		  ${featuredCardH2}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredTitleMargin?.tablet))}
		  }
		  ${featuredPrice}{
           ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredPriceMarging?.tablet))}
		  }
		  ${featuredPeriod}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredPeriodMargin?.tablet))}
		  }
		  ${featuredSection}{
		    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredFeatureSectionStyle?.featuresPadding?.tablet))}
		  }

		 ${featuredGetStarted}{
		 	${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.actionStyle?.getStartedPadding?.tablet))}
		 }
		 ${footerp}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.footerStyle?.footerDesMargin?.tablet))}
		 }
		 ${featureList}{
	    ...
	    @media only screen and (max-width: 641px) {
		  ${cardSection}{
		    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.tablePadding?.mobile))}
		  }
		  ${cardH2}{
		    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.titleStyle?.titleMargin?.mobile))}
		  }
		  ${priceTwo}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.priceStyle?.priceMarging?.mobile))}
		  }
		  ${periodTwo}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.priceStyle?.periodMargin?.mobile))}
		  }
		  ${featuresSection}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuresSectionStyle?.featuresPadding?.mobile))}
		  }
		  ${getStarted}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.actionStyle?.getStartedPadding?.mobile))}
		 }
		 ${featuredCardH2}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredTitleMargin?.mobile))}
	     }
		 ${featuredPrice}{
           ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredPriceMarging?.mobile))}
		  }
		  ${featuredPeriod}{
		   ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredPeriodMargin?.mobile))}
		  }
		  ${featuredSection}{
		    ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.featuredFeatureSectionStyle?.featuresPadding?.mobile))}
		  }
		 ${featuredGetStarted}{
		 	${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.featuredStyle?.actionStyle?.getStartedPadding?.mobile))}
		 }
		 ${footerp}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(styleTwo?.tabileRowStyle?.footerStyle?.footerDesMargin?.mobile))}
		 }
		 ${featureList}{
...
/***/ "./src/pricing-table-section/Components/Common/theme/HorizontalPricingTable.js":
/*!*************************************************************************************!*\
  !*** ./src/pricing-table-section/Components/Common/theme/HorizontalPricingTable.js ***!
  \*************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../../bpl-tools/utils/functions */ "../bpl-tools/utils/functions.js");




const HorizontalPricingTable = ({
  attributes,
  setAttributes,
  device
}) => {
  ...
  const isEditor = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(select => select('core/editor'));
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "bBlocksHorizontalPricingTable"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "main-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pricing-container"
  }, MinimalPriceCardData?.map((singleData, idx) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `${singleData.featured ? "featured" : "pricing-card"} pricing-card-${idx} `,
    key: idx
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `card-section ${featuresColumn[device] === 1 ? "card-section-oneCol" : ""}`
    ...
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, idx, "name")
    }),
    ...
    className: "price"
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "amount",
    dangerouslySetInnerHTML: {
      __html: singleData?.currencyTwo
    }
    ...
    placeholder: "Price ",
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, idx, "price")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: "period",
    ...
    placeholder: "Period ",
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, idx, "period")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
    ...
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, idx, "description")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
  }) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText.Content, {
    tagName: "p",
  ...
  }, singleData?.features?.map((feature, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "feature"
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    ...
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, idx, "features", index, "title")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
  })) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, feature?.title && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: `checkmark icon-${index}`,
    dangerouslySetInnerHTML: {
      __html: feature?.icon
    }
  ...
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    ...
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, idx, "buttonText")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
  })) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, singleData?.buttonText && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    href: singleData?.buttonLink || "#",
    className: "link-a",
    target: singleData?.buttonNewTab ? "_blank" : "_self",
    rel: singleData?.buttonNewTab ? "noopener noreferrer" : undefined
  ...
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: "footer-h3",
    tagName: "h3",
  ...
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "link-a",
    ...
    className: "icon",
    dangerouslySetInnerHTML: {
      __html: footerData?.icon
    }
  }))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, footerData?.buttonName && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "link-a",
    href: footerData?.buttonLink || "#",
    target: footerData.buttonNewTab ? "_blank" : "_self",
    rel: footerData?.buttonNewTab ? "noopener noreferrer" : undefined
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HorizontalPricingTable);

/***/ }),

/***/ "./src/pricing-table-section/Components/Common/theme/MinimalPricingTable.js":
/*!**********************************************************************************!*\
  !*** ./src/pricing-table-section/Components/Common/theme/MinimalPricingTable.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const MinimalPricingTable = ({
  ...
  const isEditor = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => select('core/editor'));
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pricing-container-one"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    key: index,
    className: `pricing-card pricing-card-${index} ${data?.highlighted && data?.highlightText ? "popular" : ""}`
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, data?.highlighted && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    ...
    placeholder: "$",
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, index, "currency")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    className: "amount",
    ...
    placeholder: "Price",
    onChange: val => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, val, index, "price")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    className: "period",
    ...
    onChange: dec => setAttributes({
      MinimalPriceCardData: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(MinimalPriceCardData, dec, index, "description")
    }),
    placeholder: "Enter Your Description",
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"]
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MinimalPricingTable);

/***/ }),

/***/ "./src/pricing-table-section/Components/Common/theme/Theme.js":
/*!********************************************************************!*\
  !*** ./src/pricing-table-section/Components/Common/theme/Theme.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _HorizontalPricingTable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./HorizontalPricingTable */ "./src/pricing-table-section/Components/Common/theme/HorizontalPricingTable.js");
/* harmony import */ var _MinimalPricingTable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MinimalPricingTable */ "./src/pricing-table-section/Components/Common/theme/MinimalPricingTable.js");
...
const Theme = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, themeStyle?.theme === "style-1" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_MinimalPricingTable__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...props
  }) : themeStyle?.theme === "style-2" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_HorizontalPricingTable__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...props
  }) : null);
};
...
/***/ "./src/pricing-table-section/style.scss":
/*!**********************************************!*\
  !*** ./src/pricing-table-section/style.scss ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*******************************************!*\
  !*** ./src/pricing-table-section/view.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/pricing-table-section/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/pricing-table-section/Components/Common/Style.js");
/* harmony import */ var _Components_Common_theme_Theme__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/theme/Theme */ "./src/pricing-table-section/Components/Common/theme/Theme.js");
