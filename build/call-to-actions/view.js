...
/***/ "./src/call-to-actions/Components/Common/Style.js":
/*!********************************************************!*\
  !*** ./src/call-to-actions/Components/Common/Style.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Style = ({
  ...
  const cssString = (0,_bpl_tools_Advanced_generateCSS__WEBPACK_IMPORTED_MODULE_1__.generateCSS)(id, advanced, isBackend);
  ...
  const gradientString = gradientObject ? gradientObject.type === 'linear' ? `linear-gradient(to bottom,  ${gradientObject.colors?.map(c => `${c.color} ${c.position}%`).join(', ')})` : `${gradientObject.type}-gradient(${gradientObject.radialType || 'ellipse'} at ${gradientObject.centerPositions?.x}% ${gradientObject.centerPositions?.y}%,${gradientObject.colors?.map(c => `${c.color} ${c.position}%`).join(', ')})` : '';
  const gradientObjectTwo = style?.ctaStyle?.title?.gradientTwo;
  const gradientStringTwo = gradientObjectTwo ? gradientObjectTwo.type === 'linear' ? `-webkit-linear-gradient(0deg,  ${gradientObjectTwo.colors?.map(c => `${c.color} ${c.position}%`).join(', ')})` : `${gradientObjectTwo.type}-gradient(${gradientObjectTwo.radialType || 'ellipse'} at ${gradientObjectTwo.centerPositions?.x}% ${gradientObjectTwo.centerPositions?.y}%,${gradientObjectTwo.colors?.map(c => `${c.color} ${c.position}%`).join(', ')})` : '';
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.ctaStyle?.title?.typo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.ctaStyle?.des?.typo)?.googleFontLink}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)('', style?.ctaStyle?.button?.typo)?.googleFontLink}

		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(ctaTitle, style?.ctaStyle?.title?.typo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(ctaSubTitle, style?.ctaStyle?.des?.typo)?.styles}
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(ctaButtonText, style?.ctaStyle?.button?.typo)?.styles}
		...
		${ctaContainerRow}{
		  ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.margin?.desktop))}
		}
		${ctaSection} {
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBackgroundCSS)(style?.ctaStyle?.background)}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.padding?.desktop))}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.radius))}
		...
		${ctaSectionThree}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.radiusThree))}
		}
	    ${ctaSectiontwo}{
		...
		${ctaButton}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.button?.padding?.desktop))}
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("border-radius", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.button?.radius))}
        ...
        @media only screen and (min-width: 641px) and (max-width: 1024px) {
			...
			${ctaContainerRow}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.margin?.tablet))}
		    }
            ${ctaSection} {
	          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.padding?.tablet))}
            }
            ${ctaButton} {
	          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.button?.padding?.tablet))}
            }
		}
		...
		@media only screen and (max-width: 641px) {
			...
			${ctaContainerRow}{
		      ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("margin", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.margin?.mobile))}
		    }
			${ctaSection} {
	          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.padding?.mobile))}
            }
			${ctaButton} {
	          ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.isValidCSS)("padding", (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBoxCSS)(style?.ctaStyle?.button?.padding?.mobile))}
            }
	    }
		${cssString}
...
/***/ "./src/call-to-actions/Components/Common/theme/CallToActionsOne.js":
/*!*************************************************************************!*\
  !*** ./src/call-to-actions/Components/Common/theme/CallToActionsOne.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const CallToActionsOne = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "cta-sub-container"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-container-row "
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-col"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-section "
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-row-section "
  }, callToActions?.map((cta, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-hero-section ",
    key: index
  }, isEditor ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "cta-title"
    ...
    onChange: v => setAttributes({
      callToActions: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(callToActions, v, index, "title")
    }),
    ...
    value: cta?.highlight,
    onChange: v => setAttributes({
      callToActions: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(callToActions, v, index, "highlight")
    }),
    allowedFormats: ["core/bold", "core/italic", "core/link", "core/text-color"],
    ...
    onChange: v => setAttributes({
      callToActions: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(callToActions, v, index, "description")
    }),
    allowedFormats: ['core/bold', 'core/italic', 'core/link', 'core/text-color'],
    ...
    target: cta.buttonNewTab ? "_blank" : "_self",
    ...
    onChange: v => setAttributes({
      callToActions: (0,_bpl_tools_utils_functions__WEBPACK_IMPORTED_MODULE_3__.updateData)(callToActions, v, index, "buttonName")
    }),
  ...
  // FrontEnd 
  (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h2", {
    className: "cta-title"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "textCta",
    dangerouslySetInnerHTML: {
    ...
    className: "cta-button-text"
  }, cta?.buttonName), showIcon && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-button-icon",
    dangerouslySetInnerHTML: {
      __html: cta?.icon
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CallToActionsOne);

/***/ }),

/***/ "./src/call-to-actions/Components/Common/theme/CallToActionsThree.js":
/*!***************************************************************************!*\
  !*** ./src/call-to-actions/Components/Common/theme/CallToActionsThree.js ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const CallToActionsThree = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "cta-section cta-section-three"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-row-section "
  }, callToActions?.map((cta, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-hero-section",
    ...
    href: cta?.buttonLink || '#',
    className: "cta-button cta-button-three",
    target: cta.buttonNewTab ? "_blank" : "_self",
    rel: cta?.buttonNewTab ? "noopener noreferrer" : undefined,
    onClick: e => e.preventDefault()
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    ...
    className: "cta-button-icon cta-button-icon-Three",
    dangerouslySetInnerHTML: {
      __html: cta?.icon
    }
  }))) :
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CallToActionsThree);

/***/ }),

/***/ "./src/call-to-actions/Components/Common/theme/CallToActionsTwo.js":
/*!*************************************************************************!*\
  !*** ./src/call-to-actions/Components/Common/theme/CallToActionsTwo.js ***!
  \*************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const CallToActionsTwo = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: "cta-section cta-section-two"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-row-section "
  }, callToActions?.map((cta, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "cta-hero-section ",
    ...
    href: cta?.buttonLink || '#',
    className: "cta-button cta-button-two",
    target: cta.buttonNewTab ? "_blank" : "_self",
    rel: cta?.buttonNewTab ? "noopener noreferrer" : undefined,
    onClick: e => e.preventDefault()
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CallToActionsTwo);

/***/ }),

/***/ "./src/call-to-actions/Components/Common/theme/Theme.js":
/*!**************************************************************!*\
  !*** ./src/call-to-actions/Components/Common/theme/Theme.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _CallToActionsOne__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CallToActionsOne */ "./src/call-to-actions/Components/Common/theme/CallToActionsOne.js");
/* harmony import */ var _CallToActionsThree__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CallToActionsThree */ "./src/call-to-actions/Components/Common/theme/CallToActionsThree.js");
/* harmony import */ var _CallToActionsTwo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CallToActionsTwo */ "./src/call-to-actions/Components/Common/theme/CallToActionsTwo.js");
...
const Theme = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, theme === "theme-1" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CallToActionsOne__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...props
  }) : theme === "theme-2" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CallToActionsTwo__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...props
  }) : theme === "theme-3" ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_CallToActionsThree__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...props
  }) : null);
};
...
/***/ "./src/call-to-actions/style.scss":
/*!****************************************!*\
  !*** ./src/call-to-actions/style.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(() => {
/*!*************************************!*\
  !*** ./src/call-to-actions/view.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_dom_client__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-dom/client */ "./node_modules/react-dom/client.js");
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/call-to-actions/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/call-to-actions/Components/Common/Style.js");
/* harmony import */ var _Components_Common_theme_Theme__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/Common/theme/Theme */ "./src/call-to-actions/Components/Common/theme/Theme.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      className: "bBlocksCallToActions"
