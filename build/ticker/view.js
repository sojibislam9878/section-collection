...
/***/ "./src/ticker/Components/Common/Style.js":
/*!***********************************************!*\
  !*** ./src/ticker/Components/Common/Style.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    dangerouslySetInnerHTML: {
      __html: `
		...
		.ticker-scroller-x__list:hover,${tickerButtonScroller}:hover,${tickerButtonScrollerSecond}:hover
		{
			...
			${tricker}{
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getColorsCSS)(ticker?.colors)}
		padding:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(ticker?.padding)};
		border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(ticker?.radius)};
		gap:${ticker?.gap};
        ...
        mask: linear-gradient(90deg, transparent, #fff ${options.effect ? "20%" : "0"}, #fff ${options.effect ? "80%" : "100%"}, transparent);
			...
			${wrapperContainer}{
			${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("min-height", styles?.height.desktop)}
					...
					${tickerButtonScroller}{
					 ...
					 .ticker-scroller-x__list{
						...
						${pulserContent}{
							...
							border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(pulserContentRadius)};
							${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBackgroundCSS)(puslerBgColor)}
							
						}
						${pulserContent}::before{
						 ${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderBoxCSS)(borderOne)}
						...
						${pulserContent}::after{
						 ...
						 ${imgFluid}{
							...
							border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(themeTwoLogoRadius)};
							${themeTwoLogo?.type === "image" ? (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderBoxCSS)(themeTwoLogoBorder) : ""}
							 ...
							 ${imgFluid} svg {
								...
								width: ${themeTwoLogoSize};
								height: ${themeTwoLogoSize};
								${themeTwoLogo?.type === "icon" ? (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBorderBoxCSS)(themeTwoLogoBorder) : ""}
								border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(themeTwoLogoRadius)};
							}
							...
							border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(pulserRadius)};
							...
							${iconImage}{
								...
								border-radius:${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.getBoxCSS)(ticker?.icon?.radius)};
...
e					   
						...
						${_bpl_tools_utils_data__WEBPACK_IMPORTED_MODULE_3__.tabBreakpoint} { 
                            ...
                            ${wrapperContainer}{ 
							${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_1__.isValidCSS)("min-height", styles?.height.mobile)}
    ...
    dangerouslySetInnerHTML: {
      __html: `${(0,_bpl_tools_Advanced_generateCSS__WEBPACK_IMPORTED_MODULE_2__["default"])(id, advanced, isBackend)}`
    }
  }));
};
...
/***/ "./src/ticker/Components/marquee/MarqueeText.js":
/*!******************************************************!*\
  !*** ./src/ticker/Components/marquee/MarqueeText.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const MarqueeText = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, selectTheme === "theme1" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, trickers.map((tricker, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, isShow ? tricker.name && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    className: "ticker",
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: `${tricker.name ? "tricker" : ""} ${!isShow ? "tricker" : ""}`
  }, isShow ? tricker.name && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    dangerouslySetInnerHTML: {
      __html: tricker?.icon
    },
    ...
    className: "d-inline-block flex-shrink-0 icon"
  }), isShow ? tricker.name && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
  ...
  }))))))), selectTheme === "theme2" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "ticker-scroller-x mb-4",
    "data-direction": options?.firstColumnDirection,
    "data-speed": "slow"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    ...
    style: {
      backgroundColor: styles?.ticker?.rightSideColors?.bg
    },
    className: `${tricker.name ? "tricker" : ""} ${!isShow ? "tricker" : ""}`
  }, isShow ? tricker.name && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    dangerouslySetInnerHTML: {
  ...
  }))))))), selectTheme === "theme3" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme3Ticker container-fluid p-0"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme3Ticker row g-0"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme3Ticker col-12"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme3Ticker scroller-x"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "theme3Ticker list theme3Ticker  list-row theme3Ticker align-items-center theme3Ticker gap-6 theme3Ticker-scroller-x__list"
  }, isShow && trickers.map((ticker, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "tickerButton tickerButtonLink",
    href: ticker?.link,
    target: options?.newTab ? "_blank" : "_self",
    rel: "noreferrer",
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, isShow ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", {
    className: "theme3Ticker mb-0 name"
  }, ticker?.name) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.RichText, {
    ...
    className: "theme3Ticker mb-0 name",
    value: ticker?.name
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    className: "iconImage",
    src: ticker?.image
  })))), !isShow && trickers.map((ticker, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "tickerButton tickerButtonLink",
    key: index
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", null, isShow ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h1", {
    className: "theme3Ticker mb-0 name"
    ...
    className: "iconImage",
    src: ticker?.image
  })))))))))), options?.duplicateColumn && selectTheme === "theme2" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: "flex"
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "ticker-scroller-x",
    "data-direction": options?.secondeColumnDirection,
    "data-speed": "slow"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("ul", {
    className: "ticker-list ticker-list-row ticker-scroller-x__list gap-4"
  }, trickers.map((tricker, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, isShow ? tricker.name && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
  ...
  })))))))), options?.duplicateColumn && selectTheme === "theme1" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: "flex"
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  })))))))), options?.duplicateColumn && selectTheme === "theme3" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    "data-direction": "left",
    className: "theme3Ticker container-fluid p-0"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "theme3Ticker row g-0",
    ...
    className: "theme3Ticker list theme3Ticker list-row theme3Ticker align-items-center theme3Ticker gap-6 theme3Ticker-scroller-x__list_second"
  }, isShow && trickers.map((ticker, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("a", {
    className: "tickerButton tickerButtonLink",
    href: ticker?.link,
    target: options?.newTab ? "_blank" : "_self",
    ...
    className: "iconImage",
    src: ticker?.image
  }))))))))))))), options?.pulserAnimation && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pulser"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pulser__content"
  }, themeTwoLogo?.type === "image" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
    src: themeTwoLogo?.image,
    alt: "image",
    className: "img-fluid"
  }), themeTwoLogo?.type === "icon" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    dangerouslySetInnerHTML: {
      __html: themeTwoLogo?.logo
    },
    className: "img-fluid"
  })))));
};
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/ticker/style.scss");
/* harmony import */ var _Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/Common/Style */ "./src/ticker/Components/Common/Style.js");
/* harmony import */ var _Components_marquee_MarqueeText__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/marquee/MarqueeText */ "./src/ticker/Components/marquee/MarqueeText.js");
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  blockNameEls.forEach(blockNameEl => {
    ...
    (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(blockNameEl).render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_Common_Style__WEBPACK_IMPORTED_MODULE_3__["default"], {
      ...
      id: blockNameEl.id
    }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_marquee_MarqueeText__WEBPACK_IMPORTED_MODULE_4__["default"], {
      isShow: true,
      attributes: attributes
    })));
